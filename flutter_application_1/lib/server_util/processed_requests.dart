...
var adres = "http://192.168.205.25:8080/api";
...
Future<int> doktorKayit(
    ...
    required String doktor_yorum}) async {
...
doktorGirisSorgusu(String doktorMAIL, String doktorSIFRE) async {
  ...
  for (var item in doktorList) {
    if (item.doktor_MAIL == doktorMAIL && item.doktor_SIFRE == doktorSIFRE) {

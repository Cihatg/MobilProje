...
import 'package:flutter_application_1/screen/page_hasta/yorum_ekle.dart';
        ...
        child: ListView(
          children: [
            ...
            _containerCreater(
                yatayGenislik: yatayGenislik,
                widget: widget,
                baslik: 'Hakkindaki Yorumlar',
                icerik:
                    '${widget.doktor.doktor_ISIM}\n\n${widget.doktor.doktor_yorum}',
                yukseklik: 500),
            SizedBox(
              height: 10,
            ),
            ElevatedButton(
                ...
                //       child: YorumEkle(doktor: widget.doktor),
                //       isIos: true,
